...
<script>
  ...
  <body>
    ...
    >
      ...
      >
        <a href="keranjang_belanja.html"
          ><button>
            ...
            /></button
        ></a>
        <a href="#hero" class="hover:text-gray-300 text-sm lg:text-base"
          >Beranda</a
        >
        <a href="#" class="hover:text-gray-300 text-sm lg:text-base">Menu</a>
        <a href="#" class="hover:text-gray-300 text-sm lg:text-base">Promo</a>
        <a href="login.php">
          <button
      ...
      >
        <div class="flex flex-col space-y-4 text-white">
          ...
          <a href="#" class="hover:text-black text-center">Beranda</a>
          <a href="#" class="hover:text-black text-center">Menu</a>
          <a href="#" class="hover:text-black text-center">Promo</a>
    ...
    <!-- Menu Section -->
    <div class="bg-[#B6EADD] px-4 sm:px-6 md:px-8 lg:px-12 py-8 md:py-12">
        ...
        <div class="relative">
          ...
          >
            ...
            <div
              class="flex-none w-60 sm:w-64 md:w-72 bg-white rounded-lg shadow-lg overflow-hidden snap-start"
            >
              <a href="menu_jajanan_pasar.html">
                <img
