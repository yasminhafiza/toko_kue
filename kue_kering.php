...
// Ambil kategori Kue Kering (id_kategori)
$query = "SELECT * FROM kategori WHERE nama_kategori = 'Kue Kering'";

// Eksekusi query dan ambil data kategori
$result = mysqli_query($koneksi, $query);
$kategori = mysqli_fetch_assoc($result);

// Ambil semua produk yang berhubungan dengan kategori Kue Kering
...
<html lang="en">
  <head>
    ...
    button.addEventListener('click', function () {
        ...
        const jumlah = 1; // Jumlah default 1
  ...
  <body class="bg-pink-100 font-sans antialiased">
    ...
    <div class="max-w-7xl mx-auto p-3 pt-24 pb-32">
      <div class="flex flex-row items-center mb-8">
        <a href="index.php"><img src="assets/foto/tombol_balik.png" alt="backing" class="mr-2" /></a>
        <h1 class="text-2xl font-bold text-gray-800">
          Menu Pilihan Kue Kering
        </h1>
      </div>
                    ...
                    <div class="p-3 flex flex-col flex-grow">
                        ...
                        <div class="flex justify-end mt-auto">
                            <form action="keranjang.php" method="POST">
                                ...
                                <input type="hidden" name="product_price" value="<?php echo $produk['harga']; ?>">
                                <button type="submit" name="add_to_cart" class="bg-green-500 text-white px-4 py-1 rounded-md hover:bg-green-600 w-auto">
                                    Tambah
                                </button>
                            </form>
                        </div>
