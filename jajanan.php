...
// Ambil kategori Jajanan Pasar (id_kategori)
...
// Ambil semua produk yang berhubungan dengan kategori Jajanan Pasar
  ...
  <body class="bg-pink-100 font-sans antialiased">
    ...
    <div class="max-w-7xl mx-auto p-3 pt-24 pb-32">
      <div class="flex flex-row items-center mb-8">
        <a href="index.php"><img src="assets/foto/tombol_balik.png" alt="backing" class="mr-2" />
        </a>
        <h1 class="text-2xl font-bold text-gray-800">
          Menu Pilihan Jajanan Pasar
        </h1>
      </div>
            ...
            <div class="bg-white rounded-lg shadow-md overflow-hidden min-w-[280px] md:w-[calc(25%-0.75rem)] flex flex-col">
                ...
                <div class="p-3 flex flex-col flex-grow">
                    ...
                    <div class="flex justify-end mt-auto">
                        <button class="bg-green-500 text-white px-4 py-1 rounded-md hover:bg-green-600 w-auto">
                            Tambah
                        </button>
                    </div>
                </div>
